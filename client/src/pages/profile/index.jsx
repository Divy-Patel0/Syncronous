   ...
   const handleDeleteImage = async() => {
    try {
      ...
      if(response.status===200){
        ...
        toast.success("Image reomved successfully.")
        setImage(null);
      }
    } catch (error) {
      console.log(error);
      ...
      <div className="flex flex-col gap-10 w-[80vw] md:w-max">
        ...
        <div className="grid grid-cols-2">
          ...
          >
            ...
            {
              hovered && (
                <div className="absolute inset-0 flex items-center justify-center bg-black/50 ring-fuchsia-500 rounded-full" onClick={image ? handleDeleteImage : handleFileInputClick}>
                  {
                    image
